...
public:
    ...
    tuple<set<vector<index_t>>, set<vector<index_t>>> getMatchedRepresentativeCycle(const size_t& dim, const size_t& index);
    set<vector<index_t>> getUnmatchedRepresentativeCycle(const size_t& dim, const size_t& index, const uint8_t& input);
    void printResult();
